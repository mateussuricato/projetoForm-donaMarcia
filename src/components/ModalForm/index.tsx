...
import {
  ...
  recepcionista,
  beneficios,
  atividadesauxiliarlimpeza,
  atividadesconfeiteiro,
  atividadesgerente,
  atividadesnutricionista,
  atividadesrecpcionista,
} from "../../mocks";
import SelectEtapas from "../SelectEtapas";
import InputRadio from "../InputRadio";
import InputCheckboxAtividades from "../InputCheckboxAtividades";
...
const ModalForm = ({
  ...
  const [atividadeState, setAtividadeState] = useState<any>(habilidades);
        ...
        <S.CheckboxContainer>
          {atividadeState.map(
            (elem: {
              ...
              return (
                <InputCheckboxAtividades
                  atividadeState={atividadeState}
                  type={"checkbox"}
                  name={elem.name}
                  key={elem.id}
